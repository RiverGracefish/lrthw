...
puts "This month I earn #{income}, and it should come in direct deposit on the 1st."
puts "I spend #{gas} on gas, and #{foods} on foods."

puts 'Am I going to have overdraft in my bank account?'
puts "Let's count!"
puts "It's greater than 0, and I still have #{balance} left in my account. No, I didn't overdraft."
